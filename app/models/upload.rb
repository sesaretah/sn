class Upload < ActiveRecord::Base
  ...
  belongs_to :stream, :class_name => "Stream", :foreign_key => "uploadable_id"
  belongs_to :post, :class_name => "Post", :foreign_key => "uploadable_id"
  belongs_to :comment, :class_name => "Comment", :foreign_key => "uploadable_id"
