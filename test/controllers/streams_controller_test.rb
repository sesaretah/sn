...
class StreamsControllerTest < ActionController::TestCase
  ...
  test "should create stream" do
    assert_difference('Stream.count') do
      post :create, stream: { subdomain: @stream.subdomain, title: @stream.title, user_id: @stream.user_id, uuid: @stream.uuid }
    end
  ...
  test "should update stream" do
    patch :update, id: @stream, stream: { subdomain: @stream.subdomain, title: @stream.title, user_id: @stream.user_id, uuid: @stream.uuid }
    assert_redirected_to stream_path(assigns(:stream))
  end
